...
const RefinanceSavingsChart = dynamic(() => import('./_charts').then(m => m.RefinanceSavingsChart), { ssr: false, loading: () => <div className="animate-pulse rounded-xl bg-neutral-100" style={{ height: 180 }} /> });
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {selectedResult && (
              <div className="bg-white rounded-xl border border-neutral-100 shadow-card p-4">
                ...
                <RefinanceSavingsChart data={chartData} scenarioDelta={scenarioDelta} />
              </div>
            )}
          </div>
        </div>

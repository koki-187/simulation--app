...
const LoanCompareBarChart = dynamic(() => import('./_charts').then(m => m.LoanCompareBarChart), { ssr: false, loading: () => <div className="animate-pulse rounded-xl bg-neutral-100" style={{ height: 240 }} /> });
        ...
        {results.length > 0 && (
          <>
            ...
            <div className="bg-white rounded-xl border border-neutral-100" style={{ boxShadow: 'var(--shadow-card)' }}>
              ...
              <div className="p-4">
                <LoanCompareBarChart data={chartData} colors={colors} slotColorMap={slotColorMap} mode={mode} />
              </div>
            </div>

...
export const REFINANCE_BANKS_2026: RefinanceBank2026[] = [
  ...
  },
  {
    ...
    maxBorrowerAge: 55,
    notes: 'LTV≤80%で1.130%（>80%は1.180%）。事務手数料2.2%（min¥220,000）または定額¥110,000（金利+0.2%）。5年ルール・1.25倍ルールあり（元利均等の場合）。全額繰上返済手数料¥55,000（重要）。一部繰上：無料。金利見直し：5月・11月（半年ごと）。⚠️借入時年齢上限55歳・最低年収550万円以上。',
    dansin: 'がん100%無料',
    applyDays: 30,
    has5YearRule: true,
    has125Rule: true,
